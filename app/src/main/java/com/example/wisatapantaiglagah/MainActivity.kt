...
package com.example.wisatapantaiglagah
...
import com.example.wisatapantaiglagah.ui.theme.WisataPantaiGlagahTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
       //lamda setconten yang ada di oncreate 
        setContent {
            //lamda WisataPantaiGlagahTheme yang ada didalam lamda set conten
            WisataPantaiGlagahTheme {
                //fungsi WisataApp() tanpa paramater
                WisataApp()
                    }
                }
            }
        ...
        when (currentStep) {
            1 -> {
                ...
                Column (
                    ...
                    //teks PANTAI GLAGAH INDAH
                    Text("PANTAI GLAGAH INDAH")
                    //spasi dengan 32 dp
                    ...
                    //teks
                    Text("Pantai yang paling terkenal di Kulon Progo adalah Pantai Glagah. " +
                            "Pantai ini dikenal memiliki laguna dan tetrapod beton yang dapat memecah ombak secara maksimal." +
                            "Ombak yang menghantam tetrapod inilah yang akan menghasilkan deburan ombak di pinggir pantai." +
                            "Tak sebatas itu, ada banyak informasi yang wajib kamu ketahui tentang Pantai Glagah. ")
            ...
            2 -> {
                Column (
                    ...
                    Text("Nah, siapa yang saat berwisata merasa bagian paling seru adalah berburu oleh-oleh?" +
